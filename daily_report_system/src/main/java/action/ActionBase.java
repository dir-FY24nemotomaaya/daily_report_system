...
public abstract class ActionBase {
    protected ServletContext context; //Webアプリケーションのコンテクスト情報
     ...
     */
    public void init(  //各クラスのフィールドの値を設定
    ...
    /**
     * パラメーターのcommandの値に該当するメソッドを実行する。値が不正な場合はエラー画面を呼びだす
     * @throws ServletException
     * @throws IOException
     */
